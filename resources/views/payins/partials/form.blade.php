...
<x-template.text-field name="input" :label="__('Input')" type="text" :value="request()->input ?? old('input')" :required=false/>
...
<div class="form-group row">
  <label for="start_time" class="col-md-4 col-form-label">{{ __('Date') }}</label>
  <div class="col-md-3">
